...
const badgeStyles = {
  ...
  attitude: "bg-orange-100 text-orange-700 dark:bg-orange-500/15 dark:text-orange-300",
  success: "bg-lime-100 text-lime-700 dark:bg-lime-500/15 dark:text-lime-300",
  breakup: "bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-300",
  happy: "bg-yellow-100 text-yellow-700 dark:bg-yellow-500/15 dark:text-yellow-300",
  alone: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/15 dark:text-fuchsia-300",
  nature: "bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-300",
  birthday: "bg-pink-100 text-pink-700 dark:bg-pink-500/15 dark:text-pink-300",
  political: "bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-300",
  foodie: "bg-cyan-100 text-cyan-700 dark:bg-cyan-500/15 dark:text-cyan-300",
  travel: "bg-purple-100 text-purple-700 dark:bg-purple-500/15 dark:text-purple-300",
};
